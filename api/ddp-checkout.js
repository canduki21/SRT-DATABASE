...
const DEFAULT_RATES = {
  AR: { name: 'Argentina',     duty_rate: 0.20,   tax_rate: 0.21,  brokerage_fee: 60, processing_fee: 35 },
  ...
  BD: { name: 'Bangladesh',    duty_rate: 0.25,   tax_rate: 0.15,  brokerage_fee: 50, processing_fee: 30 },
  BE: { name: 'Belgium',       duty_rate: 0.035,  tax_rate: 0.21,  brokerage_fee: 25, processing_fee: 20 },
  BG: { name: 'Bulgaria',      duty_rate: 0.035,  tax_rate: 0.20,  brokerage_fee: 25, processing_fee: 20 },
  BH: { name: 'Bahrain',       duty_rate: 0.05,   tax_rate: 0.10,  brokerage_fee: 35, processing_fee: 25 },
  ...
  CL: { name: 'Chile',         duty_rate: 0.06,   tax_rate: 0.19,  brokerage_fee: 40, processing_fee: 25 },
  CN: { name: 'China',         duty_rate: 0.10,   tax_rate: 0.13,  brokerage_fee: 40, processing_fee: 25 },
  CO: { name: 'Colombia',      duty_rate: 0.15,   tax_rate: 0.19,  brokerage_fee: 45, processing_fee: 25 },
  HR: { name: 'Croatia',       duty_rate: 0.035,  tax_rate: 0.25,  brokerage_fee: 25, processing_fee: 20 },
  CY: { name: 'Cyprus',        duty_rate: 0.035,  tax_rate: 0.19,  brokerage_fee: 25, processing_fee: 20 },
  ...
  EC: { name: 'Ecuador',       duty_rate: 0.12,   tax_rate: 0.15,  brokerage_fee: 45, processing_fee: 25 },
  EE: { name: 'Estonia',       duty_rate: 0.035,  tax_rate: 0.22,  brokerage_fee: 25, processing_fee: 20 },
  EG: { name: 'Egypt',         duty_rate: 0.20,   tax_rate: 0.14,  brokerage_fee: 50, processing_fee: 30 },
  ...
  HK: { name: 'Hong Kong',     duty_rate: 0.00,   tax_rate: 0.00,  brokerage_fee: 25, processing_fee: 20 },
  HU: { name: 'Hungary',       duty_rate: 0.035,  tax_rate: 0.27,  brokerage_fee: 25, processing_fee: 20 },
  IS: { name: 'Iceland',       duty_rate: 0.00,   tax_rate: 0.24,  brokerage_fee: 30, processing_fee: 20 },
  IN: { name: 'India',         duty_rate: 0.10,   tax_rate: 0.18,  brokerage_fee: 40, processing_fee: 25 },
  ID: { name: 'Indonesia',     duty_rate: 0.15,   tax_rate: 0.11,  brokerage_fee: 45, processing_fee: 25 },
  ...
  JO: { name: 'Jordan',        duty_rate: 0.20,   tax_rate: 0.16,  brokerage_fee: 40, processing_fee: 25 },
  KE: { name: 'Kenya',         duty_rate: 0.25,   tax_rate: 0.16,  brokerage_fee: 50, processing_fee: 30 },
  KR: { name: 'South Korea',   duty_rate: 0.08,   tax_rate: 0.10,  brokerage_fee: 30, processing_fee: 20 },
  KW: { name: 'Kuwait',        duty_rate: 0.05,   tax_rate: 0.00,  brokerage_fee: 35, processing_fee: 25 },
  LT: { name: 'Lithuania',     duty_rate: 0.035,  tax_rate: 0.21,  brokerage_fee: 25, processing_fee: 20 },
  LU: { name: 'Luxembourg',    duty_rate: 0.035,  tax_rate: 0.17,  brokerage_fee: 25, processing_fee: 20 },
  LV: { name: 'Latvia',        duty_rate: 0.035,  tax_rate: 0.21,  brokerage_fee: 25, processing_fee: 20 },
  MA: { name: 'Morocco',       duty_rate: 0.025,  tax_rate: 0.20,  brokerage_fee: 40, processing_fee: 25 },
  MT: { name: 'Malta',         duty_rate: 0.035,  tax_rate: 0.18,  brokerage_fee: 25, processing_fee: 20 },
  MX: { name: 'Mexico',        duty_rate: 0.10,   tax_rate: 0.16,  brokerage_fee: 35, processing_fee: 25 },
  MY: { name: 'Malaysia',      duty_rate: 0.10,   tax_rate: 0.08,  brokerage_fee: 35, processing_fee: 25 },
  NG: { name: 'Nigeria',       duty_rate: 0.20,   tax_rate: 0.075, brokerage_fee: 60, processing_fee: 35 },
  ...
  PE: { name: 'Peru',          duty_rate: 0.11,   tax_rate: 0.16,  brokerage_fee: 45, processing_fee: 25 },
  PH: { name: 'Philippines',   duty_rate: 0.10,   tax_rate: 0.12,  brokerage_fee: 40, processing_fee: 25 },
  PK: { name: 'Pakistan',      duty_rate: 0.25,   tax_rate: 0.17,  brokerage_fee: 50, processing_fee: 30 },
  ...
  QA: { name: 'Qatar',         duty_rate: 0.05,   tax_rate: 0.00,  brokerage_fee: 35, processing_fee: 25 },
  RO: { name: 'Romania',       duty_rate: 0.035,  tax_rate: 0.19,  brokerage_fee: 25, processing_fee: 20 },
  RS: { name: 'Serbia',        duty_rate: 0.05,   tax_rate: 0.20,  brokerage_fee: 35, processing_fee: 20 },
  ...
  SI: { name: 'Slovenia',      duty_rate: 0.035,  tax_rate: 0.22,  brokerage_fee: 25, processing_fee: 20 },
  SK: { name: 'Slovakia',      duty_rate: 0.035,  tax_rate: 0.20,  brokerage_fee: 25, processing_fee: 20 },
  ...
  TH: { name: 'Thailand',      duty_rate: 0.20,   tax_rate: 0.07,  brokerage_fee: 40, processing_fee: 25 },
  TR: { name: 'Turkey',        duty_rate: 0.035,  tax_rate: 0.20,  brokerage_fee: 35, processing_fee: 25 },
  TW: { name: 'Taiwan',        duty_rate: 0.05,   tax_rate: 0.05,  brokerage_fee: 30, processing_fee: 20 },
  UA: { name: 'Ukraine',       duty_rate: 0.10,   tax_rate: 0.20,  brokerage_fee: 40, processing_fee: 25 },
  ...
  UY: { name: 'Uruguay',       duty_rate: 0.20,   tax_rate: 0.22,  brokerage_fee: 50, processing_fee: 30 },
  VN: { name: 'Vietnam',       duty_rate: 0.12,   tax_rate: 0.10,  brokerage_fee: 40, processing_fee: 25 },
  ZA: { name: 'South Africa',  duty_rate: 0.20,   tax_rate: 0.15,  brokerage_fee: 45, processing_fee: 30 },
};
